...
var division = calculator( 77, 11 )
var mod = calculator( 36, 5 )
...
console.log( subtraction(function(x, y){ return x - y }) ) // 6

console.log( 'O resultado da multiplicação é:')
console.log( multiplication(function(x, y){ return x * y })) // 42

console.log( 'O resultado da divisão é:')
console.log( division(function(x, y){ return x / y })) // 7

console.log( 'O resto da divisão é:')
console.log( mod(function(x, y){ return x % y })) // 1